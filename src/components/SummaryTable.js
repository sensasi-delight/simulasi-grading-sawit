...
import ValueTableCell from '../components/ValueTableCell.tsx';
...
export default function SummaryTable({ dataset }) {
	...
	const finalWeight = dataset[0]?.weight - dataset[1]?.weight + dataset[2]?.weight;
	...
	return (
		<TableContainer sx={SX_TABLE_CONTAINER}>
			<Table size="small" sx={SX_TABLE}>
				...
				<TableFooter>
					<TableRow>
						<TableCell component='th' scope='row'>HASIL AKHIR</TableCell>
