...
export default function TermsAndConditionsPage() {
    return (
        <main>
            ...
            <br />
            <p>
                These terms and conditions apply to the Simulasi Grading Sawit
                app (hereby referred to as "Application") that was created by
                Sensasi Apps (hereby referred to as "Service Provider") as an Ad
                Supported service.
            </p>
            <br />
            <p>
            ...
            <div>
                <p>
                    ...
                    services that have their own Terms and Conditions. Below are
                    the links to the Terms and Conditions of the third-party
            ...
            <br />
            <p>These terms and conditions are effective as of 2025-12-06</p>
            <br />
            <strong>Contact Us</strong>
            <p>
                If you have any questions or suggestions about the Terms and
                Conditions, please do not hesitate to contact the Service
                Provider at sensasi.apps@gmail.com.
            </p>
            <hr />
            <p>
